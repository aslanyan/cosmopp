...
HEALPIX_AND_LAPACK_OBJ = obj/simulate.o obj/likelihood.o obj/master.o
HEALPIX_AND_LAPACK_TARGET = bin/generate_white_noise
...
MINUIT_AND_LAPACK_OBJ = obj/gaussian_process.o
MINUIT_AND_LAPACK_TEST_OBJ = obj/test_gaussian_process.o

PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_OBJ = obj/planck_like_fast.o
PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_TEST_OBJ = obj/test_mcmc_planck_fast.o

PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_AND_MULTINEST_TEST_OBJ = obj/test_multinest_planck_fast.o

PLANCK_AND_POLYCHORD_AND_CLASS_TEST_OBJ = obj/test_polychord_planck.o

ifdef LAPACK
LAPACK_COMPILE_FLAGS = -D COSMO_LAPACK
LAPACK_LIB_FLAGS1 =
LAPACK_LIB_FLAGS2 = $(LAPACK)
LAPACK_OBJ = obj/mcmc.o
LAPACK_TEST_OBJ = obj/test_mcmc.o
LAPACK_TARGET = bin/example_metropolis_hastings
else
LAPACK_COMPILE_FLAGS =
LAPACK_LIB_FLAGS1 =
LAPACK_LIB_FLAGS2 =
CLASS_AND_LAPACK_OBJ =
CLASS_AND_LAPACK_TEST_OBJ =
HEALPIX_AND_LAPACK_OBJ =
HEALPIX_AND_LAPACK_TARGET =
HEALPIX_AND_LAPACK_AND_CLASS_TEST_OBJ =
MINUIT_AND_LAPACK_OBJ =
MINUIT_AND_LAPACK_TEST_OBJ =
PLANCK_AND_CLASS_AND_LAPACK_TEST_OBJ =
ANN_AND_LAPACK_OBJ =
ANN_AND_LAPACK_TEST_OBJ =
PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_OBJ =
PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_TEST_OBJ =
PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_AND_MULTINEST_TEST_OBJ =
endif
...
PLANCK_AND_POLYCHORD_AND_CLASS_TEST_OBJ =
...
ifdef POLYCHORD
ifndef POLYCHORDCOMPILER
$(error Need to specify POLYCHORDCOMPILER if POLYCHORD is specified) 
endif
ifndef POLYCHORDLIBFLAGS
$(error Need to specify POLYCHORDLIBFLAGS if POLYCHORD is specified)
endif
ifeq ($(POLYCHORDCOMPILER),gfortran)
POLYCHORD_COMPILE_FLAGS = -D COSMO_POLYCHORD -D POLYCHORD_GFORT
else
POLYCHORD_COMPILE_FLAGS = -D COSMO_POLYCHORD -D POLYCHORD_IFORT
endif
POLYCHORD_INCLUDE_FLAGS =
POLYCHORD_LIB_FLAGS1 = -L $(POLYCHORD)/src
POLYCHORD_LIB_FLAGS2 = $(POLYCHORDLIBFLAGS)
...
POLYCHORD_FC_FLAGS = $(MPI_COMPILE_FLAGS) -cpp -c -I $(POLYCHORD)/src
POLYCHORD_OBJ = obj/polychord_wrapper.o obj/polychord.o
POLYCHORD_TEST_OBJ = obj/test_polychord.o
else
POLYCHORD_COMPILE_FLAGS =
POLYCHORD_INCLUDE_FLAGS =
POLYCHORD_LIB_FLAGS1 =
POLYCHORD_LIB_FLAGS2 =
POLYCHORD_OBJ =
POLYCHORD_TEST_OBJ =
PLANCK_AND_POLYCHORD_AND_CLASS_TEST_OBJ =
endif
...
LFLAGS1 = $(LAPACK_LIB_FLAGS1) $(HEALPIX_LIB_FLAGS1) $(CLASS_LIB_FLAGS1) $(MINUIT_LIB_FLAGS1) $(MULTINEST_LIB_FLAGS1) $(POLYCHORD_LIB_FLAGS1) $(PLANCK_LIB_FLAGS1) $(WMAP_LIB_FLAGS1) $(ANN_LIB_FLAGS1) -fopenmp

LFLAGS2 = -lstdc++ $(LAPACK_LIB_FLAGS2) $(HEALPIX_LIB_FLAGS2) $(CLASS_LIB_FLAGS2) $(MINUIT_LIB_FLAGS2) $(MULTINEST_LIB_FLAGS2) $(POLYCHORD_LIB_FLAGS2) $(PLANCK_LIB_FLAGS2) $(WMAP_LIB_FLAGS2) $(ANN_LIB_FLAGS2)

MYFLAGS = $(MY_COMPILE_FLAGS) $(LAPACK_COMPILE_FLAGS) $(HEALPIX_COMPILE_FLAGS) $(CLASS_COMPILE_FLAGS) $(MINUIT_COMPILE_FLAGS) $(MULTINEST_COMPILE_FLAGS) $(POLYCHORD_COMPILE_FLAGS) $(PLANCK_COMPILE_FLAGS) $(WMAP_COMPILE_FLAGS) $(ANN_COMPILE_FLAGS) $(MPI_COMPILE_FLAGS) $(OMP_COMPILE_FLAGS)

INCLUDE_FLAGS = -I include $(HEALPIX_INCLUDE_FLAGS) $(CLASS_INCLUDE_FLAGS) $(MINUIT_INCLUDE_FLAGS) $(MULTINEST_INCLUDE_FLAGS) $(POLYCHORD_INCLUDE_FLAGS) $(PLANCK_INCLUDE_FLAGS) $(WMAP_INCLUDE_FLAGS) $(ANN_INCLUDE_FLAGS)
...
MATRIX_HPP = include/matrix.hpp
MATRIX_IMPL_HPP = include/matrix_impl.hpp $(MATRIX_HPP) $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP)
...
MCMC_HPP = include/mcmc.hpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(MATH_CONSTANTS_HPP) $(LIKELIHOOD_FUNCTION_HPP) $(RANDOM_HPP) $(MATRIX_IMPL_HPP)
...
POLYCHORD_HPP = include/polychord.hpp $(MACROS_HPP) $(LIKELIHOOD_FUNCTION_HPP)

POLYCHORD_WRAPPER_H = include/polychord_wrapper.h
...
LIKELIHOOD_HPP = include/likelihood.hpp $(COMPLEX_TYPES_HPP) $(C_MATRIX_HPP) $(WHOLE_MATRIX_HPP) $(MATRIX_HPP)
MASTER_HPP = include/master.hpp $(MACROS_HPP) $(MATRIX_HPP)
...
MATTER_LIKELIHOOD_HPP = include/matter_likelihood.hpp $(FUNCTION_HPP) $(COSMOLOGICAL_PARAMS_HPP) $(MATRIX_HPP)
PLANCK_LIKE_FAST_HPP = include/planck_like_fast.hpp $(PLANCK_LIKE_HPP) $(CMB_HPP) $(LEARN_AS_YOU_GO_HPP)
...
TEST_POLYCHORD_HPP = include/test_polychord.hpp $(TEST_FRAMEWORK_HPP)
...
TEST_POLYCHORD_PLANCK_HPP = include/test_polychord_planck.hpp $(TEST_FRAMEWORK_HPP)
...
TEST_GAUSSIAN_PROCESS_HPP = include/test_gaussian_process.hpp $(TEST_FRAMEWORK_HPP)
TEST_MCMC_PLANCK_FAST_HPP = include/test_mcmc_planck_fast.hpp $(TEST_FRAMEWORK_HPP)
TEST_MULTINEST_PLANCK_FAST_HPP = include/test_multinest_planck_fast.hpp $(TEST_FRAMEWORK_HPP)

GENERAL_TARGET =

all: lib/libcosmopp.a bin/test $(GENERAL_TARGET) $(HEALPIX_AND_LAPACK_TARGET) $(HEALPIX_TARGET) $(CLASS_TARGET) $(PLANCK_AND_CLASS_TARGET) $(PLANCK_AND_MULTINEST_AND_CLASS_TARGET) $(LAPACK_TARGET)

GENERAL_OBJ = obj/macros.o obj/test_framework.o obj/whole_matrix.o obj/scale_factor.o obj/markov_chain.o obj/matrix_impl.o

OBJ_LIBRARY = $(GENERAL_OBJ) $(HEALPIX_OBJ) $(LAPACK_OBJ) $(CLASS_AND_LAPACK_OBJ) $(HEALPIX_AND_LAPACK_OBJ) $(CLASS_OBJ) $(MULTINEST_OBJ) $(POLYCHORD_OBJ) $(PLANCK_OBJ) $(PLANCK_AND_CLASS_OBJ) $(WMAP_OBJ) $(WMAP_AND_CLASS_OBJ) $(ANN_OBJ) $(ANN_AND_LAPACK_OBJ) $(MINUIT_AND_LAPACK_OBJ) $(PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_OBJ)
...
OBJ_TEST = $(OBJ_LIBRARY) $(GENERAL_TEST_OBJ) $(MULTINEST_TEST_OBJ) $(POLYCHORD_TEST_OBJ) $(PLANCK_TEST_OBJ) $(PLANCK_AND_MULTINEST_AND_CLASS_TEST_OBJ) $(PLANCK_AND_POLYCHORD_AND_CLASS_TEST_OBJ) $(CLASS_TEST_OBJ) $(CLASS_AND_LAPACK_TEST_OBJ) $(PLANCK_AND_CLASS_TEST_OBJ) $(LAPACK_TEST_OBJ) $(HEALPIX_TEST_OBJ) $(HEALPIX_AND_LAPACK_AND_CLASS_TEST_OBJ) $(MINUIT_TEST_OBJ) $(WMAP_AND_CLASS_TEST_OBJ) $(PLANCK_AND_CLASS_AND_LAPACK_TEST_OBJ) $(ANN_TEST_OBJ) $(ANN_AND_LAPACK_TEST_OBJ) $(MINUIT_AND_LAPACK_TEST_OBJ) $(PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_TEST_OBJ) $(PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_AND_MULTINEST_TEST_OBJ)
bin/test: $(OBJ_TEST)
...
ifdef HEALPIX_AND_LAPACK_TARGET
OBJ_GENERATE_WHITE_NOISE = obj/generate_white_noise.o obj/macros.o obj/simulate.o obj/whole_matrix.o obj/matrix_impl.o
...
obj/matrix_impl.o: source/matrix_impl.cpp $(MATRIX_IMPL_HPP)
	$(CC) $(CFLAGS) source/matrix_impl.cpp -o $@
...
obj/likelihood.o: source/likelihood.cpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(NUMERICS_HPP) $(PROGRESS_METER_HPP) $(THREE_ROTATION_HPP) $(LIKELIHOOD_HPP) $(UTILS_HPP) $(MATRIX_IMPL_HPP)
	$(CC) $(CFLAGS) source/likelihood.cpp -o $@

obj/master.o: source/master.cpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(MATH_CONSTANTS_HPP) $(PROGRESS_METER_HPP) $(WIGNER_3J_HPP) $(MASTER_HPP) $(MATRIX_IMPL_HPP)
...
obj/simulate.o: source/simulate.cpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(NUMERICS_HPP) $(WHOLE_MATRIX_HPP) $(RANDOM_HPP) $(MATRIX_IMPL_HPP) $(SIMULATE_HPP)
	$(CC) $(CFLAGS) source/simulate.cpp -o $@

obj/test.o: source/test.cpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(TEST_FRAMEWORK_HPP) $(TEST_UNIT_CONVERSIONS_HPP) $(TEST_INT_OPERATIONS_HPP) $(TEST_INTEGRAL_HPP) $(TEST_CONJUGATE_GRADIENT_HPP) $(TEST_POLYNOMIAL_HPP) $(TEST_LEGENDRE_HPP) $(TEST_SPHERICAL_HARMONICS_HPP) $(TEST_MATRIX_HPP) $(TEST_MCMC_HPP) $(TEST_MULTINEST_HPP) $(TEST_POLYCHORD_HPP) $(TEST_MCMC_PLANCK_HPP) $(TEST_MULTINEST_PLANCK_HPP) $(TEST_POLYCHORD_PLANCK_HPP) $(TEST_CMB_HPP) $(TEST_CMB_GIBBS_HPP) $(TEST_FIT_HPP) $(TEST_PLANCK_LIKE_HPP) $(TEST_WMAP9_LIKE_HPP) $(TEST_LIKE_HIGH_HPP) $(TEST_LIKE_LOW_HPP) $(TEST_WIGNER_3J_HPP) $(TEST_TABLE_FUNCTION_HPP) $(TEST_CUBIC_SPLINE_HPP) $(TEST_THREE_ROTATION_HPP) $(TEST_MASK_APODIZER_HPP) $(TEST_MATTER_LIKELIHOOD_HPP) $(TEST_K_NEAREST_NEIGHBORS_HPP) $(TEST_FAST_APPROXIMATOR_HPP) $(TEST_FAST_APPROXIMATOR_ERROR_HPP) $(TEST_GAUSSIAN_PROCESS_HPP) $(TEST_MCMC_PLANCK_FAST_HPP) $(TEST_MULTINEST_PLANCK_FAST_HPP)
...
obj/matter_likelihood.o: source/matter_likelihood.cpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(SCALE_FACTOR_HPP) $(UNIT_CONVERSIONS_HPP) $(MATTER_LIKELIHOOD_HPP) $(MATRIX_IMPL_HPP)
...
obj/test_multinest_planck.o: source/test_multinest_planck.cpp $(TEST_MULTINEST_PLANCK_HPP) $(MN_SCANNER_HPP) $(PLANCK_LIKE_HPP) $(MARKOV_CHAIN_HPP) $(NUMERICS_HPP) $(TIMER_HPP)
...
obj/polychord.o: source/polychord.cpp $(MACROS_HPP) $(EXCEPTION_HANDLER_HPP) $(MATH_CONSTANTS_HPP) $(POLYCHORD_HPP) $(POLYCHORD_WRAPPER_H)
	$(CC) $(CFLAGS) source/polychord.cpp -o $@

obj/test_polychord.o: source/test_polychord.cpp $(TEST_POLYCHORD_HPP) $(POLYCHORD_HPP) $(MARKOV_CHAIN_HPP) $(NUMERICS_HPP)
	$(CC) $(CFLAGS) source/test_polychord.cpp -o $@

obj/test_polychord_planck.o: source/test_polychord_planck.cpp $(TEST_POLYCHORD_PLANKC_HPP) $(POLYCHORD_HPP) $(PLANCK_LIKE_HPP) $(MARKOV_CHAIN_HPP) $(NUMERICS_HPP)
	$(CC) $(CFLAGS) source/test_polychord_planck.cpp -o $@





obj/polychord_wrapper.o: source/polychord_wrapper.f90
	$(POLYCHORD_FC) $(POLYCHORD_FC_FLAGS) source/polychord_wrapper.f90 -o $@
