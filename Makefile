...
OBJ_LIBRARY = $(GENERAL_OBJ) $(HEALPIX_OBJ) $(LAPACKPP_OBJ) $(CLASS_AND_LAPACK_OBJ) $(HEALPIX_AND_LAPACKPP_OBJ) $(CLASS_OBJ) $(MULTINEST_OBJ) $(PLANCK_OBJ) $(PLANCK_AND_CLASS_OBJ) $(WMAP_OBJ) $(WMAP_AND_CLASS_OBJ) $(ANN_OBJ) $(ANN_AND_LAPACK_OBJ) $(MINUIT_AND_LAPACKPP_OBJ) $(PLANCK_AND_CLASS_AND_ANN_AND_LAPACK_OBJ)
