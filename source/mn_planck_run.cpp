...
class LCDMRunParams : public LambdaCDMParams
{
public:
    LCDMRunParams(double omBH2, double omCH2, double h, double tau, double ns, double as, double pivot, double run = 0.0) : LambdaCDMParams(omBH2, omCH2, h, tau, ns, as, pivot, run) {}
    virtual ~LCDMRunParams() {}

    virtual std::string name() const { return "LCDMRun"; }
...
int main(int argc, char *argv[])
{
    try {
        ...
        LCDMRunParams par(0.022, 0.12, 0.7, 0.1, 1.0, std::exp(3.0) / 1e10, pivot);
        ...
        root << "slow_test_files/mn_planck_run";
        //if(useFast)
            //root << "_fast";
        ...
        */
...
#else
        mn.setParam(7, "A_ps_100", 0, 360);
        mn.setParam(8, "A_ps_143", 0, 270);
        mn.setParam(9, "A_ps_217", 0, 450);
        mn.setParam(10, "A_cib_143", 0, 20);
        mn.setParam(11, "A_cib_217", 0, 80);
        mn.setParam(12, "A_sz", 0, 10);
        mn.setParam(13, "r_ps", 0.0, 1.0);
        mn.setParam(14, "r_cib", 0.0, 1.0);
        mn.setParam(15, "n_Dl_cib", -2, 2);
        mn.setParam(16, "cal_100", 0.98, 1.02);
        mn.setParam(17, "cal_127", 0.95, 1.05);
        mn.setParam(18, "xi_sz_cib", 0, 1);
        mn.setParam(19, "A_ksz", 0, 10);
        mn.setParam(20, "Bm_1_1", -20, 20);
#endif
        ...
        output_screen("MN Planck run took " << time / 1000000 << " seconds." << std::endl);
