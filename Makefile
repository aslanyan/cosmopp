...
LFLAGS1 = $(LAPACK_LIB_FLAGS1) $(HEALPIX_LIB_FLAGS1) $(CLASS_LIB_FLAGS1) $(MINUIT_LIB_FLAGS1) $(MULTINEST_LIB_FLAGS1) $(POLYCHORD_LIB_FLAGS1) $(PLANCK_LIB_FLAGS1) $(WMAP_LIB_FLAGS1) -fopenmp

LFLAGS2 = -lstdc++ $(LAPACK_LIB_FLAGS2) $(HEALPIX_LIB_FLAGS2) $(CLASS_LIB_FLAGS2) $(MINUIT_LIB_FLAGS2) $(MULTINEST_LIB_FLAGS2) $(POLYCHORD_LIB_FLAGS2) $(PLANCK_LIB_FLAGS2) $(WMAP_LIB_FLAGS2)

MYFLAGS = $(MY_COMPILE_FLAGS) $(LAPACK_COMPILE_FLAGS) $(HEALPIX_COMPILE_FLAGS) $(CLASS_COMPILE_FLAGS) $(MINUIT_COMPILE_FLAGS) $(MULTINEST_COMPILE_FLAGS) $(POLYCHORD_COMPILE_FLAGS) $(PLANCK_COMPILE_FLAGS) $(WMAP_COMPILE_FLAGS) $(MPI_COMPILE_FLAGS) $(OMP_COMPILE_FLAGS)

INCLUDE_FLAGS = -I include $(HEALPIX_INCLUDE_FLAGS) $(CLASS_INCLUDE_FLAGS) $(MINUIT_INCLUDE_FLAGS) $(MULTINEST_INCLUDE_FLAGS) $(POLYCHORD_INCLUDE_FLAGS) $(PLANCK_INCLUDE_FLAGS) $(WMAP_INCLUDE_FLAGS)
...
OBJ_LIBRARY = $(GENERAL_OBJ) $(HEALPIX_OBJ) $(LAPACK_OBJ) $(CLASS_AND_LAPACK_OBJ) $(HEALPIX_AND_LAPACK_OBJ) $(CLASS_OBJ) $(MULTINEST_OBJ) $(POLYCHORD_OBJ) $(PLANCK_OBJ) $(PLANCK_AND_CLASS_OBJ) $(WMAP_OBJ) $(WMAP_AND_CLASS_OBJ)
