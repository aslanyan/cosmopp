...
POLYCHORD_COMPILE_FLAGS = $(MPI_COMPILE_FLAGS) -D COSMO_POLYCHORD -D POLYCHORD_GFORT
else
POLYCHORD_COMPILE_FLAGS = $(MPI_COMPILE_FLAGS) -D COSMO_POLYCHORD -D POLYCHORD_IFORT
endif
