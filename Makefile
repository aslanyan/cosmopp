...
LFLAGS1 = $(HEALPIX_LIB_FLAGS1) $(LAPACKPP_LIB_FLAGS1) $(CLASS_LIB_FLAGS1) $(MINUIT_LIB_FLAGS1) $(MULTINEST_LIB_FLAGS1) $(POLYCHORD_LIB_FLAGS1) $(PLANCK_LIB_FLAGS1) $(WMAP_LIB_FLAGS1) -fopenmp

LFLAGS2 = -lstdc++ $(HEALPIX_LIB_FLAGS2) $(LAPACKPP_LIB_FLAGS2) $(CLASS_LIB_FLAGS2) $(MINUIT_LIB_FLAGS2) $(MULTINEST_LIB_FLAGS2) $(POLYCHORD_LIB_FLAGS2) $(PLANCK_LIB_FLAGS2) $(WMAP_LIB_FLAGS2)

MYFLAGS = $(MY_COMPILE_FLAGS) $(HEALPIX_COMPILE_FLAGS) $(LAPACKPP_COMPILE_FLAGS) $(CLASS_COMPILE_FLAGS) $(MINUIT_COMPILE_FLAGS) $(MULTINEST_COMPILE_FLAGS) $(POLYCHORD_COMPILE_FLAGS) $(PLANCK_COMPILE_FLAGS) $(WMAP_COMPILE_FLAGS) $(MPI_COMPILE_FLAGS) $(OMP_COMPILE_FLAGS)
