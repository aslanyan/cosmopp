...
All of the information, including compiling and installation instructions, as well as the code documentation can be found at http://cosmopp.com.

The code is also available on github: https://github.com/aslanyan/cosmopp. Here you can always find the latest version.

Bugs, feature requests, or any other issues should be submitted to https://github.com/aslanyan/cosmopp/issues.

Please email questions and comments to Grigor Aslanyan, g.aslanyan@auckland.ac.nz.
